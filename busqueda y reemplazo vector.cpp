...
cout<<"------------------------------"<<endl;
 ...
 cin>>op;
    ...
    if(op == 1) {
        ...
        cout<<"Ingrese la posicion del elemento a reemplazar (0 a 5): "<<endl;
        cin>>nuevaposicion;

        if(nuevaposicion >= 0 && nuevaposicion < 6) {
            cout<<"Ingrese el nuevo valor para la posicion "<<nuevaposicion<<endl;
            cin>>nuevovalor;
            ...
            cout<<"La posición ingresada estafuera de la capacidad del vector"<<endl;
            system("pause");
            system("cls");
        }
    }
